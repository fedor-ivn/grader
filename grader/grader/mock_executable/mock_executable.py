from grader.mock_executable.pipe import (
    MockExecutablePipe,
)
from grader.mock_executable.pipe_session import (
    PipeSession,
)
import os
import grader.mock_executable.args_proxy as args_proxy


class MockExecutable:
    def __init__(self, name: str, pipes_path: str) -> None:
        self.name = name
