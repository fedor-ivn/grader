...
from eobot.raw_types.message.chat import RawChat
from eobot.raw_types.message.document import RawDocument
from eobot.raw_types.message.raw_entity import RawEntity
from eobot.raw_types.raw import RawType
from eobot.tgtypes.message.document import DocumentMessage

from eobot.tgtypes.message.message import Message

from eobot.tgtypes.message.text import Text, TextMessage
